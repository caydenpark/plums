  ...
  return (
    ...
    >
      <div className="flex min-h-screen items-center justify-center px-4 pb-20 pt-4 text-center sm:block sm:p-0">
        ...
        <div className="inline-block transform overflow-hidden rounded-lg bg-slate-200 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
